    ...
    public partial class Property_Looking_For : System.Web.UI.Page
    {
        ...
        public void SendMailToAdmin(string UserEmailId)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                mail.Subject = "Ray Nanda - Property Looking for : '" + txtFirstName.Text + " :  " + txtPhoneno.Text;
                //string body = "";
                ...
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>Ray Nanda<br/>Broker of record</p>");
